...
# Select the seventh binary vector (corresponding to the seventh motor unit)
binary_vector = firing_samples[0][6]
...
# Plot the seventh binary vector and its corresponding filtered version
...
# Compare the firing rates of the fourth and seventh motor units
# To determine which unit fires faster, count the number of spikes in each binary vector and compare.
num_spikes_unit_4 = np.sum(firing_samples[0][3])
num_spikes_unit_7 = np.sum(firing_samples[0][6])

if num_spikes_unit_4 > num_spikes_unit_7:
    print("Motor Unit 4 fires faster.")
    print("Explanation: Motor Unit 4 has a higher spike count in its binary vector, indicating a higher firing rate.")
elif num_spikes_unit_7 > num_spikes_unit_4:
    print("Motor Unit 7 fires faster.")
    print("Explanation: Motor Unit 7 has a higher spike count in its binary vector, indicating a higher firing rate.")
else:
    print("Motor Unit 4 and Motor Unit 7 have the same firing rate.")
    print("Explanation: Both units have an equal spike count in their respective binary vectors.")
